...
/// SwiftUI bridge around `NSTextView`. Hosts the editable buffer the user
/// manipulates during a drill. Disables all macOS auto-complete/substitution
/// behavior so kindaVim motions produce exactly the keystrokes the engine
/// expects. Focus state is reported back through `onFocusChange`.
