...
extension Curriculum {
    ...
    private static let lesson1_modes = Lesson(
        ...
        explanation: [
            ...
            .text("Every Mac text field starts in **Insert mode** — click in, type, letters appear. kindaVim adds a second mode, **Normal mode**, where those same letters become commands. Watch:"),
            .spacer,
            .modesDemo,
            .spacer,
            ...
            .spacer,
            .text("The chip in the top-right is your live mode. Watch it flip while you practice."),
            .spacer,
