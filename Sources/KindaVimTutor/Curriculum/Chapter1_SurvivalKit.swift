...
extension Curriculum {
    ...
    private static let lesson1_1 = Lesson(
        ...
        explanation: [
            .heading("First, Enter Normal Mode"),
            .text("kindaVim is Vim mode for macOS — it works anywhere you can type: this tutor, Xcode, Safari, Mail. When you click into a text field, kindaVim starts in Insert mode so you can type normally."),
            .spacer,
            .text("To use Vim motions, press Esc to flip into Normal mode. The chip in the top toolbar confirms which mode you're in:"),
            .spacer,
            .modePreview(.insert, caption: "While typing, you'll see the blue INSERT chip."),
            .modePreview(.normal, caption: "After pressing Esc, it flips to green NORMAL — motions like h j k l now move the cursor."),
            .spacer,
            .keyCommand(keys: ["Esc"], description: "Switch to Normal mode"),
            .spacer,
            .tip("If a motion seems to type letters instead of moving the cursor, you're still in Insert mode — press Esc and try again."),
            .spacer,
